...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty eventPointerDown;
    private SerializedProperty eventPointerUp;
    ...
    protected virtual void OnEnable()
    {
        ...
        eventPointerDown = serializedObject.FindProperty("_onPointerDownEvent");
        eventPointerUp = serializedObject.FindProperty("_onPointerUpEvent");
    }
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(eventPointerDown, new GUIContent("Pointer Down Event", "Event when player start moving joystick"));
        EditorGUILayout.PropertyField(eventPointerUp, new GUIContent("Pointer Up Event", "Event when player stop moving joystick"));
    }
